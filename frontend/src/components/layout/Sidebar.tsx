...
const NAV_LINKS: { href: string; label: string; icon: typeof IconDashboard; roles: string[] | null }[] = [
  ...
  { href: "/welfare-contributions", label: "Welfare & Contributions", icon: IconReceipt, roles: ALL_COMMUNITY_ROLES },
  ...
  { href: "/my-receipts", label: "My Receipts", icon: IconReceipt, roles: ALL_COMMUNITY_ROLES },
